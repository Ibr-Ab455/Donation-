    ...
    <div className='w-full h-screen'>
      <div className='form-content flex items-center justify-center py-10'>
         <form className='flex flex-col gap-4 w-[40%] p-6 bg-[#010100]'>
            <h1 className='text-white text-2xl'>Register you account</h1>
            <hr/>
            <div className='flex flex-col gap-1'>
            <label className='text-sm text-gray-500'>Full Name</label>
             <input type='text' placeholder='Ibrahim Ahmed' className='w-[80%] border-1 rounded border-gray-500 outline-none p-2'/>
            </div>
            ...
            <div>
                <span className='text-white'>Have an account ? <Link to="/login" className='text-blue-600'>Login</Link></span>
            </div>
         </form>
        </div>
    </div>
